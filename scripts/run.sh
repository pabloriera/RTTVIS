...
export PYTHON_ENV_DIR="${PYTHON_ENV_DIR:-/models/python/venv}"
export VIRTUAL_ENV="${VIRTUAL_ENV:-${PYTHON_ENV_DIR}}"
export PATH="${VIRTUAL_ENV}/bin:${PATH}"

export PIP_CACHE_DIR="${PIP_CACHE_DIR:-/models/pip-cache}"
...
export IMAGE_MODEL_DIR="${IMAGE_MODEL_DIR:-/models/image/sd-turbo}"
...
export Z_IMAGE_MODEL_DIR="${Z_IMAGE_MODEL_DIR:-/models/image/z-image-turbo}"
...
export LUMINA_IMAGE_MODEL_DIR="${LUMINA_IMAGE_MODEL_DIR:-/models/image/lumina-image-2}"
...
export ASR_MODEL_PATH="${ASR_MODEL_PATH:-/models/asr/vosk-model-es-0.42}"
export ASR_SAMPLE_RATE="${ASR_SAMPLE_RATE:-16000}"

export LIBRETRANSLATE_URL="${LIBRETRANSLATE_URL:-http://172.18.0.1:5000}"
