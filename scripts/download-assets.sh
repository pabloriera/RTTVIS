...
PYTHON_ENV_DIR="${PYTHON_ENV_DIR:-/models/python/venv}"
PIP_CACHE_DIR="${PIP_CACHE_DIR:-/models/pip-cache}"
...
IMAGE_MODEL_DIR="${IMAGE_MODEL_DIR:-/models/image/sd-turbo}"
Z_IMAGE_MODEL_ID="${Z_IMAGE_MODEL_ID:-Tongyi-MAI/Z-Image-Turbo}"
Z_IMAGE_MODEL_DIR="${Z_IMAGE_MODEL_DIR:-/models/image/z-image-turbo}"
LUMINA_IMAGE_MODEL_ID="${LUMINA_IMAGE_MODEL_ID:-Alpha-VLLM/Lumina-Image-2.0}"
LUMINA_IMAGE_MODEL_DIR="${LUMINA_IMAGE_MODEL_DIR:-/models/image/lumina-image-2}"
ASR_MODELS_DIR="${ASR_MODELS_DIR:-/models/asr}"
